...
#   [ ] Verify that everything in this code is reflected in my RLKIT
#   [ ] ??? Type up and document. Then start attempts. 

def experiment(variant):
    # NOTE: The kwargs here are failing???
    #       Should be connecting to RLBench in some manner
